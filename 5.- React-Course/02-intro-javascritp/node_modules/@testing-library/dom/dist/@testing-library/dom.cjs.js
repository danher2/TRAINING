...
var _prettyFormat$plugins = prettyFormat__default['default'].plugins,
...
function prettyDOM(dom, maxLength, options) {
  ...
  var debugContent = prettyFormat__default['default'](dom, _extends__default['default']({
...
function queryAllByRole(container, role, _temp) {
  ...
  if (expanded !== undefined) {
    ...
    // guard against unknown roles
    if (((_allRoles$get4 = ariaQuery.roles.get(role)) == null ? void 0 : _allRoles$get4.props['aria-expanded']) === undefined) {
...
function _waitForElement() {
  _waitForElement = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee(callback, options) {
    return _regeneratorRuntime__default['default'].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
...
Object.defineProperty(exports, 'prettyFormat', {
  enumerable: true,
  get: function () {
    return prettyFormat__default['default'];
  }
});
