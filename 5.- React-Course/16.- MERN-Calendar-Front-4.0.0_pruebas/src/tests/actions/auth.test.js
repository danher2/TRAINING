...
import * as fetchModule from '../../helpers/fetch'; // se importa todo en este modulo de otra manera
...
describe('Pruebas en las acciones Auth', () => {
    ...
    test('startRegister correcto', async() => {
        ...
        fetchModule.fetchSinToken = jest.fn(() => ({// mock del fecth sin token, un metodo dentro de todo el modulo
            json() {
                return { // regresa un objeto reconstruido aqui mismo
                    ok: true,
                    uid: '123',
                    name: 'carlos',
                    token: 'ABC123ABC123'
